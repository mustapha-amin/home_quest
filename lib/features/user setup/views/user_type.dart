...
final userTypeCtrl = StateProvider<UserType?>((ref) {
        ...
        Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                UserTypeWidget(
                  selectedUserType: ref.watch(userTypeCtrl),
                  name: "agent",
                  onTap: () {
                    if (ref.watch(progressCtrl) == 0) {
                      updateProgressVal(ref, 0.5);
                    }
                    ref.read(userTypeCtrl.notifier).state = UserType.agent;
                  },
                ),
                UserTypeWidget(
                  selectedUserType: ref.watch(userTypeCtrl),
                  ...
                  onTap: () {
                    ...
                    ref.read(userTypeCtrl.notifier).state = UserType.client;
                  },
                ),
              ],
            ),
