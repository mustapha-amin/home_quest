        ...
        body: Column(
          children: [
            ...
            CustomButton(
              ...
              onTap: () {
                listingFeatures = [
                  ...textControllers.map((ctrl) => ListingFeature(
                      feature: Feature.values[textControllers.indexOf(ctrl)],
                      number: int.parse(ctrl.text)))
                ];
                log(selectedFacilities.toString());
                log(listingFeatures.toString());
                if (ref.watch(pickedImagesCtrl).length > 4 &&
